...
urlpatterns = [
    ...
    path('accept_group/<int:group_id>/<int:notif_slug>', views.accept_group, name='accept_group'),
    path('deny_group/<int:group_id>/<int:notif_slug>', views.deny_group, name='deny_group'),
